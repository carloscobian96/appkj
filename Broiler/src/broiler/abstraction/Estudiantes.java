...
public class Estudiantes extends TableItem {
	// private String tablename="estudiante";

	Integer ID;
	Integer Numero_Estudiante;
	Integer Ano_Estudiante;
	String Grado;
	String Semestre;
	String Nombre;
	String sexo;
	...
	String Ultima_Carta_Descripcion;
	Double Desc_Matricula;
	String procede;
	Integer Beca;
	Double Ahorros;
	...
	Double Vencido;
	Double Total_Pagado;
	Double Total_Pendiente;
	String Mes_Pago;
	boolean active;

	public Estudiantes(final Integer iD, final Integer numero_Estudiante, final Integer ano_Estudiante,
	...
	public Estudiantes(final String[] s) {
		super();
...
//	public int update(DatabaseConnect d) throws SQLException, IllegalArgumentException, IllegalAccessException {
