...
import iconix.appkademyj.empleados.EditarEmpleado;
import iconix.appkademyj.empleados.EmpleadoOld;
import iconix.appkademyj.util.ErrorFrame;
import iconix.database.DatabaseConnect;

public class BuscarEmpleado2 extends JInternalFrame {
	/**
	 * 
	 */
	...
	public BuscarEmpleado2(final iconix.database.DatabaseConnect d) {
		...
		resultTable.setModel(d.getTable("select * from empleados"));
