...
public class RootFrameAppKademyJ extends JFrame {
	...
	public static void main(final String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					final RootFrameAppKademyJ frame = new RootFrameAppKademyJ();
					frame.setVisible(true);

					 LoginDialog loginDlg = new LoginDialog(frame);
					 loginDlg.setVisible(true);
					 if (loginDlg.isSucceeded()) {
					 frame.setTitle("APPKADEMYJ: " + loginDlg.getUsername());
	...
	public RootFrameAppKademyJ() {

		// LOAD DEFAULT DIMENSIONS
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				RootFrameAppKademyJ.class.getResource("/com/sun/java/swing/plaf/windows/icons/HardDrive.gif")));
		...
		mntmCrearEmpleado.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(final ActionEvent arg0) {
				final CrearEmpleado a = new CrearEmpleado(d);
				a.setVisible(true);
				desktopPane.add(a);
				a.toFront();
				a.requestFocus();
		...
		mntmVerEmpleados.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(final ActionEvent arg0) {
				final BuscarEmpleado a = new BuscarEmpleado(d);
				a.setVisible(true);
				desktopPane.add(a);
				a.toFront();
				a.requestFocus();
		...
		mntmResetData.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent arg0) {
				try {
					...
					e.printStackTrace();
					ErrorFrame frame = new ErrorFrame(e, "Error Resetting Data CONTACT ICONIX BEFORE PROCEEDING");
					frame.setVisible(true);
				}
		...
		mntmInformacion.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(final ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Creado por Carlos Jose Cobian \n Producto de Iconix Group \n Distribucion 2");
			}
		});
		...
		gl_contentPane.setHorizontalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane.createSequentialGroup()
						.addComponent(desktopPane, GroupLayout.DEFAULT_SIZE, 1651, Short.MAX_VALUE).addContainerGap()));
		gl_contentPane.setVerticalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane.createSequentialGroup()
						.addComponent(desktopPane, GroupLayout.DEFAULT_SIZE, 1054, Short.MAX_VALUE).addContainerGap()));
