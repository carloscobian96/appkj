...
public class CrearEmpleado extends JInternalFrame {
	...
	public CrearEmpleado(final DatabaseConnect d) {
		setClosable(true);
		...
		btnCrear.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent arg0) {
				try {
					...
					if (verify()) {
						final EmpleadoOld e = new EmpleadoOld(nombreField.getText(), Integer.parseInt(ssnField.getText()),
